...
module.exports = {
    ...
    await queryInterface.bulkInsert('Breweries', [
      {
        ...
        brewery_state: 'NY',
        description: 'Located in Brooklyn, NY, Sixpoint is a great place to kick back and relax with friends',
      },
      {
      ...
      },
      {
        ...
        brewery_state: 'MI',
        description: "itty bitty Ann Arbor side hustle, OG smooj producer, heavily fruited hard seltzers, a child of Troobado"
      },
    ], {});
  },
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkDelete('Breweries', {
        name: { [Sequelize.Op.in]: ["Sixpoint Brewery", "Pips Meadery", "Smooj"]}
      });
  }
};
